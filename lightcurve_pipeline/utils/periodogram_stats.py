"""Generate lomb-scargle periodogram statistics

The periodogram statistics are used in the stats table in the hstlc
database as well as the periodogram plots generated by the
