...
Use:
    ...
    product_type (Required) - The type of lightcurves to process. Can
        be "individual" for individual lightcurves, "composite" for
...
def get_lightcurves(product_type):
    ...
    ----------
    product_type : string
        The type of lightcurves to process. Can either be 'individual',
        'composite', or 'both'.
...
def get_stats(dataset):
    ...
    stats_dict : dictionary
        A dictionary whose keys are column names of the 'stats' table
        and whose values are the corresponding statistics.
    """
